...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomePageState&&(identical(other.homeCategory, homeCategory) || other.homeCategory == homeCategory));
}


@override
int get hashCode => Object.hash(runtimeType,homeCategory);

@override
String toString() {
  return 'HomePageState(homeCategory: $homeCategory)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomePageState&&(identical(other.homeCategory, homeCategory) || other.homeCategory == homeCategory));
}
