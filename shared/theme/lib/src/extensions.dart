...
extension AppThemeX on ThemeData {
  ...
  AppTextTheme get appTextTheme =>
      extension<AppTextTheme>() ?? AppTextTheme.light();
}
...
extension ContextX on BuildContext {
  ...
  /// similar to `MediaQuery.of(this).textScaler.scale(1) / 1`
  double get textScaleFactor => MediaQuery.of(this).textScaler.scale(1) / 1;
  ...
  num scaleFactorValue(num originalValue) {
    ...
    return originalValue * textScaleFactor;
  }

  int toPhysicalPixel(num value) => (value * devicePixelRatio).toInt();
}
